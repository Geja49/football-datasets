"""Gestionnaire HTTP — page admin Solo (pronos weekend)."""
...
from communaute import utilisateur_connecte
from modeles.solo import (
    ParametresPronosWeekend,
    ReponseBilanSolo,
    ReponsePronosWeekend,
)
from services.solo_fige import bilan_weekend_solo, construire_pronos_weekend_ou_figes
